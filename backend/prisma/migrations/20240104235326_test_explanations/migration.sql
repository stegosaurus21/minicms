...
INSERT INTO "new_Test" ("challenge_id", "comment", "input", "is_example", "output", "task_number") SELECT "challenge_id", "comment", "input", "is_example", "output", "task_number" FROM "Test";
DROP TABLE "Test";
